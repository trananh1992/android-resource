...
public class TextRegionFactory
{
			...
			GamePlay game)
	{
		...
		for(int i = 1; i <= GameControl.FishKindsNum; i++)	// FishKindsNum==5
		{
	...
	public TiledTextureRegion CreateRegionForGold(Engine mEngine, GamePlay game)
	{
		BitmapTextureAtlas goldTexture = new BitmapTextureAtlas(1024, 1024, TextureOptions.DEFAULT);
		TiledTextureRegion gold = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(
				goldTexture, game, "gold.png", 0, 0, 6, 1);
		mEngine.getTextureManager().loadTexture(goldTexture);
		return gold;
	}
