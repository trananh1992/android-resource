...
public class TextSE{
	...
	public void createTexts(final Font font, final Scene scene, final GamePlay gamePlay, String text) 
	{
		/* 开始游戏Text. */
		final Text titleText = new Text(0, 0, font, text, HorizontalAlign.CENTER);
...
//		scene.registerUpdateHandler(new TimerHandler(GameControl.GAME_TIME, new ITimerCallback() {
//			
...
//		}));
//		
//		scene.registerUpdateHandler(new TimerHandler(GameControl.GAMN_END_TIME, new ITimerCallback() {
//			
//			public void onTimePassed(TimerHandler pTimerHandler) {
//				// TODO Auto-generated method stub
//				scene.unregisterUpdateHandler(pTimerHandler);
