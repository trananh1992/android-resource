...
public class FpsActivity extends BaseGameActivity {
	 private static final int CAMERA_WIDTH = 320;
	    private static final int CAMERA_HEIGHT = 480;
	    private Camera andCamera;
	    //private Texture myFontTexture;			//Texture:抽象类，无法使用
	    private BitmapTextureAtlas myFontTexture;
	    private Font myFont;
	    ...
	    public void onLoadResources() {
	        // 构建一个纹理用以显示文字
	        this.myFontTexture = new BitmapTextureAtlas(256, 256, TextureOptions.DEFAULT);
	        // 构建字体
	        this.myFont = new Font(this.myFontTexture, Typeface.create(Typeface.DEFAULT, Typeface.BOLD), 32, true, Color.WHITE);
	        // 注入相关纹理及字体
